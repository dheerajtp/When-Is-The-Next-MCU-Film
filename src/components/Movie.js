...
function Movie({
  ...
  nextoverview,
  nextimage,
  nexttitle,nextdate,following_production
}) {
    const dispatch = useDispatch();
  if(Object.keys(following_production).length===0){
    return(
        <Empty/>
    );
  }else{
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <div className="flex justify-center">
                <dl className="flex items-center mt-6 space-x-8 text-xs">
                  ...
                  <div className="sm:inline-flex sm:items-center sm:shrink-0">
                  <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="30" height="30"><path d="M3.5 0v5m8-5v5m-4 1v5M5 8.5h5m-8.5-6h12a1 1 0 011 1v10a1 1 0 01-1 1h-12a1 1 0 01-1-1v-10a1 1 0 011-1z" stroke="currentColor"></path></svg>
                    <div className="sm:ml-3 mt-1.5 sm:mt-0">
